...
const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary:
      "bg-brand-blue text-white hover:bg-blue-600 shadow-lg shadow-blue-900/20 hover:shadow-blue-600/30 hover:-translate-y-0.5",
    secondary:
      "bg-gray-100 text-gray-900 hover:bg-gray-200 hover:-translate-y-0.5",
    outline:
      "border border-gray-300 bg-transparent hover:bg-gray-50 text-gray-700 hover:border-gray-400",
