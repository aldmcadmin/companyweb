      ...
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <ScrollReveal delay={0.2}>
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
            <Link to="/contact">
              <button 
                className="group relative overflow-hidden bg-brand-blue hover:bg-[#334155] text-white px-10 py-5 text-lg rounded-full shadow-2xl shadow-blue-900/20 hover:shadow-slate-800/30 transition-all duration-300 ease-spring active:scale-95"
              >
            ...
            <div className="flex items-center justify-center space-x-3 text-gray-600 bg-white px-6 py-3 rounded-full border border-gray-200 shadow-sm group hover:border-gray-300 transition-colors">
              <span className="relative flex h-3 w-3">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-3 w-3 bg-green-500"></span>
              </span>
              <span className="text-sm font-bold group-hover:text-gray-900 transition-colors">{t.contact.banner.hours}</span>
            </div>
          </div>
        </ScrollReveal>
      </div>
